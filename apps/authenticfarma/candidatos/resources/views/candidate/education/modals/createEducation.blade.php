...
<div id="modalAgregarEducacion" class="custom-modal-overlay" role="dialog" aria-labelledby="tituloAgregarEducacion" aria-hidden="true">
  <div class="custom-modal custom-modal--large">
    ...
    <div class="modal-body" id="crearEducacionBody">
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    const trigger = document.querySelector('[data-modal-target="modalAgregarEducacion"]');
    const modal = document.getElementById('modalAgregarEducacion');
    const modalBody = document.getElementById('crearEducacionBody');
