...
<div id="modalEliminarEducacion" class="custom-modal-overlay" role="dialog" aria-labelledby="tituloEliminarEducacion" aria-hidden="true">
...
<form id="formEliminarEducacion" method="POST" style="display: none;">
  @csrf
  @method('DELETE')
</form>
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    const modal = document.getElementById('modalEliminarEducacion');
    ...
    const formEliminar = document.getElementById('formEliminarEducacion');

    let idSeleccionado = null;

    // Activar modal al hacer clic en el botón eliminar
    document.querySelectorAll('.btn-eliminar-educacion').forEach(btn => {
    ...
    btnConfirmar.addEventListener('click', function () {
      if (idSeleccionado) {
        formEliminar.setAttribute('action', `/educacion/${idSeleccionado}`);
        formEliminar.submit();
      }
    });
  });
