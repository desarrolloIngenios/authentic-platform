...
<div id="modalEditarEducacion" class="custom-modal-overlay" role="dialog" aria-labelledby="tituloEditarEducacion" aria-hidden="true">
  <div class="custom-modal custom-modal--large">
    ...
    <div class="modal-body" id="editarEducacionBody">
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    ...
    const modal = document.getElementById('modalEditarEducacion');
    const modalBody = document.getElementById('editarEducacionBody');
