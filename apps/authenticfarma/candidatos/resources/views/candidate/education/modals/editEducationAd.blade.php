...
<div id="modalEditarEducacionAd" class="custom-modal-overlay" role="dialog" aria-labelledby="tituloEditarEducacion" aria-hidden="true">
  <div class="custom-modal custom-modal--large">
    <div class="custom-modal-header">
      <h2 id="tituloEditarEducacion" class="custom-modal-title">
        ...
        Editar Formación Académica Adicional
      </h2>
      <button class="custom-modal-close">&times;</button>
    </div>
    <div class="modal-body" id="editarEducacionAdBody">
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    ...
    const modal = document.getElementById('modalEditarEducacionAd');
    const modalBody = document.getElementById('editarEducacionAdBody');
    const loading = document.getElementById('loadingCrear');
    const closeBtn = modal.querySelector('.custom-modal-close');

    document.querySelectorAll('.editar-educacionad').forEach(button => {
      button.addEventListener('click', function (e) {
        ...
        fetch(`/educationad/modal-edit/${id}`)
