...
class PDFProcessingService
{
    ...
    protected function processWithGemini($pdfText)
    {
        $prompt = "
            ...
            4. **Experiencia laboral**: Busca secciones que comiencen con 'Experiencia' o 'Historial laboral'. Para cada experiencia, extrae un objeto JSON con estas claves exactas: "empresa" (nombre de la empresa u organización, OBLIGATORIO, si no está explícito usa "Empresa no especificada"), "puesto" (cargo o posición), "fecha_inicio" (formato año-mes-dia ejemplo '2013-11-22'), "fecha_fin" (formato año-mes-dia o null si es actual), "descripcion" (breve descripción de responsabilidades). Devuelve un array de estos objetos.
